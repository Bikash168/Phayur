    ...
    return (
        <header className="w-full bg-white shadow-md fixed top-0 z-50">
            <div className="max-w-screen-xl mx-auto px-4 py-3 flex justify-between items-center md:px-8">
                {/* Logo */}
                <div className="relative h-10 sm:h-12 md:h-14 lg:h-16 w-24 sm:w-28 md:w-32 lg:w-36">
                    <Image
                        src="/logo.png"
                        alt="Phayur"
                        fill
                ...
                {/* Desktop Navigation */}
                <nav className="hidden md:flex space-x-6 text-green-900 text-sm md:text-base font-medium">
                    {navLinks.map((link) => (
